...
async function findPlayerByKey(input){
...
// ===== 管理员：加钱（支持 user_id / username / phone）=====
...
return res.json({
success:false,
msg:"找不到玩家，请检查 ID / USERNAME / PHONE"
});
...
// ===== 管理员：BONUS加分（支持 user_id / username / phone）=====
...
return res.json({
success:false,
msg:"玩家ID / USERNAME / PHONE 或 Bonus 金额错误 / ข้อมูลผู้เล่นหรือจำนวนโบนัสไม่ถูกต้อง"
});
...
return res.json({
success:false,
msg:"找不到玩家，请检查 ID / USERNAME / PHONE / ไม่พบผู้เล่น"
});
...
// ===== 管理员：扣钱（支持 user_id / username / phone）=====
